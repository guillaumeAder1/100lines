require(["esri/Map", "esri/views/SceneView", "esri/layers/GraphicsLayer", "esri/Graphic", "esri/geometry/Point", "esri/symbols/SimpleMarkerSymbol", "dojo/dom", "dojo/domReady!", "dojo/request/xhr"], function(Map, SceneView, Graphicslayer, Graphic, Point, SimpleMarkerSymbol, dom, domReady, xhr) {
    ...
    view.then(function() {
        ...
        xhr.get('flights.json').then(processFlights);
    });
});